//! Normalisation applied to the JSON Schema groove advertises for its MCP tools.
//!
...
/// parameter groove exposes already carries its real, much narrower range in the
