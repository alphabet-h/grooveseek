//! A plugin missing [`groove_grammar_abi::symbols::NAME`].
//!
...
// `groove_grammar_name` is deliberately absent: it is the point of the fixture.
...
pub extern "C" fn groove_grammar_build_info() -> *const c_char {
    c"grooveseek test fixture; grammar noname".as_ptr()
}
