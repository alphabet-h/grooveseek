...
')
REVIEW_BODY=$(echo "$NEW_REVIEWS" | jq -r '.[-1].body // ""')
...
echo "$NEW_REVIEWS" | jq -r '.[-1].body // "(no new review body this round)"'
echo ""
